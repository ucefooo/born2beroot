...
## Installation
At the time of writing, the latest stable version of [Debian](https://www.debian.org) is *Debian 11 Buster*. Watch *bonus* installation walkthrough *(no audio)* [here](https://youtu.be/OQEdjt38ZJA).
